...
@section('content')
    <div class="">
        <div class="container">
            <div class="capitalize"> {{ Route::currentRouteName() }}</div>
            @auth
                    ...
                    <form method="POST" action="{{ route('login.user', app()->getLocale()) }}">
                        ...
                        <div class="mt-8">
                            ...
                            <a href="{{ route('register', app()->getLocale()) }}"
                                class="text-primary">{{ __('registration') }}</a>
                        </div>
                        <div class="flex items-center justify-end mt-4">
                            <a class="ml-1 btn bg-primary" href="{{ route('login.facebook', app()->getLocale()) }}"
